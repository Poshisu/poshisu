...
### Phase 1 contract freeze (approved on 2026-05-02)

- Primary onboarding mode is **chat-first** (wizard prompts remain historical fallback only).
- Phase 1 onboarding UX copy is **conversational English only** for MVP.
- Mandatory onboarding is constrained to the six-step set defined in `docs/ONBOARDING_FLOW.md`.
- Progressive questions remain deferred/contextual and are explicitly out of mandatory onboarding scope.
