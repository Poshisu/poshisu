...
- **FAIL/major:** image/camera, audio/voice, and file controls are unavailable in production UI; onboarding explicitly shows `Photo upload coming soon`, `Camera coming soon`, `File upload coming soon`, and `Voice coming soon`; `/chat` shows none of these controls.
