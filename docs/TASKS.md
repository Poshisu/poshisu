...
### Current active task
- **Next to execute:** `S2-T03` (Harden `/api/chat` beta contract).
- **Owner:** Engineering
...
- **Current active:** `S2-T03` (in_progress)
- **Next:** `S3-T01` `/api/meals` CRUD implementation
- **Then:** `S3-T02` `/api/memory` read/write implementation
