...
### Current active task
- **Next to execute:** `S3-T01` (Implement `/api/meals` CRUD).
- **Owner:** Engineering
...
- **Current active:** `S3-T01` (in_progress)
- **Next:** `S3-T02` `/api/memory` read/write implementation
- **Then:** `S3-T03` `/api/push` subscription lifecycle
